...
public class RocketMQTransactionProcedure {
    ...
    public void sendTransactionMessage() {
        TransactionMQProducer producer = new TransactionMQProducer(ROCKETMQ_GROUP);
        producer.setNamesrvAddr(ROCKETMQ_NAMESRV);
//        producer.setCheckThreadPoolMinSize(2);
//        producer.setCheckThreadPoolMaxSize(2);
//        producer.setCheckRequestHoldMax(2000);
        producer.setCheckThreadPoolMinSize(1);
        producer.setCheckThreadPoolMaxSize(1);
        producer.setCheckRequestHoldMax(2000);
        ...
        try {
            ...
            for (int i = 0; i <10 ; i++) {
                Message msg = new Message(ROCKETMQ_TOPIC, "transaction", null, ("Hello RocketMQ "+i).getBytes());
                //发送事务消息
